"""
Django settings for vodavoz project.
...
ALLOWED_HOSTS = ['127.0.0.1', 'vodavoz.herokuapp.com', 'localhost']
...
WSGI_APPLICATION = 'vodavoz.wsgi.application'
